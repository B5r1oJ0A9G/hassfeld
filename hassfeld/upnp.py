...
def set_mute(
    ...
    device = upnpclient.Device(location)
    device.RenderingControl.SetMute(
...
def set_room_volume(location, room, desired_volume, instance_id=0):
    ...
    """
    device = upnpclient.Device(location)
    device.RenderingControl.SetRoomVolume(
...
def set_room_mute(location, room, desired_mute=True, instance_id=0):
    ...
    device = upnpclient.Device(location)
    device.RenderingControl.SetRoomMute(
        InstanceID=instance_id, Room=room, DesiredMute=desired_mute
    )
...
def get_volume(location, channel="Master", instance_id=0):
    ...
    """
    device = upnpclient.Device(location)
    response = device.RenderingControl.GetVolume(
